...
final userModelExtensionController = StateNotifierProvider<UserModelExtensionController, UserModelExtension?>(
      (ref) => UserModelExtensionController(ref.read),
);

class UserModelExtensionController extends StateNotifier<UserModelExtension?> {
  final Reader _read;

  StreamSubscription<UserModelExtension>? userModelChangesSubscription;

  UserModelExtensionController(this._read) : super(null) {

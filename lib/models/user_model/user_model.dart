...
class UserModel with _$UserModel{
  ...
  @Default("Available to work")String?available,UserRatingModel?ratings,Map<String,dynamic>? orgDetailModel,String? fcmtoken,String? email, WalletModel? wallet,String?documentId,@Default(false) bool isDismissCompleteProfile,List<String>?states,bool? isActiveService,bool? toggleNationWideVisibility,String?transactionPin,required bool buyerNotification,required bool inboxNotification,required bool orderNotification})=_UserModel;

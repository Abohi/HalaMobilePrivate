...
import '../models/active_servicemodel/active_service_model.dart' as _i73;
import '../models/modification_model/modification_model.dart' as _i79;
import '../models/notification_model/notification_model.dart' as _i77;
import '../models/offer_model/offer_model.dart' as _i75;
import '../models/order_model/order_model.dart' as _i78;
import '../models/requests_model/request_model2.dart' as _i74;
import '../models/user_model/user_model.dart' as _i76;
...
import '../pages/basic_verification_pages/resend_email_verification_link_page.dart'
    as _i5;
import '../pages/dashboard_pages/dashboard_page.dart' as _i67;
import '../pages/dashboard_pages/pages/create_request_page.dart' as _i72;
...
import '../pages/dashboard_pages/pages/drawer_pages/payment_pages/pages/withdraw_funds_page.dart'
    as _i40;
import '../pages/dashboard_pages/pages/drawer_pages/payment_pages/pages/withdrawfunds_history_page.dart'
    as _i41;
...
import '../pages/dashboard_pages/pages/drawer_pages/settings_page/create_pin_page.dart'
    as _i36;
import '../pages/dashboard_pages/pages/drawer_pages/settings_page/notification_settings_page.dart'
    as _i42;
...
import '../pages/dashboard_pages/pages/home_pages/service_pages/subservice_page.dart'
    as _i27;
import '../pages/dashboard_pages/pages/homepage.dart' as _i68;
import '../pages/dashboard_pages/pages/inbox_pages/inbox_detail_page.dart'
    as _i50;
import '../pages/dashboard_pages/pages/inboxpage.dart' as _i69;
import '../pages/dashboard_pages/pages/notification_pages/notification_detail_page.dart'
    as _i49;
import '../pages/dashboard_pages/pages/notificationpage.dart' as _i70;
...
import '../pages/dashboard_pages/pages/request_pages/send_offer_page.dart'
    as _i43;
import '../pages/dashboard_pages/pages/requestpage.dart' as _i71;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    AddAccountDetailRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i32.AddAccountDetailPage();
        }),
    AddAccountRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i33.AddAccountPage();
        }),
    ...
    WithDrawfundHistoryRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i41.WithDrawfundHistoryPage();
        }),
    NotificationSettingsRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (_) {
          return _i42.NotificationSettingsPage();
        }),
    SendOfferRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        routeData: routeData,
        builder: (data) {
          final args = data.argsAs<SendOfferRouteArgs>();
          return _i43.SendOfferPage(
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(AddAccountDetailRoute.name,
        ...
        _i1.RouteConfig(WithDrawfundHistoryRoute.name,
            path: '/with-drawfund-history-page'),
        _i1.RouteConfig(NotificationSettingsRoute.name,
...
class ByServiceDetailRoute extends _i1.PageRouteInfo<ByServiceDetailRouteArgs> {
  ByServiceDetailRoute({required _i73.ActiveServiceModel serviceModel})
      : super(name,
            path: '/by-service-detail-page',
...
class SubserviceRouteArgs {
  ...
  final _i73.ActiveServiceModel activeServiceModel;
}
...
class AddAccountDetailRoute extends _i1.PageRouteInfo {
  const AddAccountDetailRoute() : super(name, path: '/add-account-detail-page');

  static const String name = 'AddAccountDetailRoute';
}

class AddAccountRoute extends _i1.PageRouteInfo {
...
class WithDrawfundHistoryRoute extends _i1.PageRouteInfo {
  const WithDrawfundHistoryRoute()
      : super(name, path: '/with-drawfund-history-page');

  static const String name = 'WithDrawfundHistoryRoute';
}

class NotificationSettingsRoute extends _i1.PageRouteInfo {
  const NotificationSettingsRoute()
      : super(name, path: '/notification-settings-page');

  static const String name = 'NotificationSettingsRoute';
}

class SendOfferRoute extends _i1.PageRouteInfo<SendOfferRouteArgs> {
  SendOfferRoute({required _i74.CreateRequestModel2 createRequestModel2})
      : super(name,
...
class SendOfferRouteArgs {
  ...
  final _i74.CreateRequestModel2 createRequestModel2;
}
...
class OfferSentDetailRoute extends _i1.PageRouteInfo<OfferSentDetailRouteArgs> {
  OfferSentDetailRoute(
      {required _i75.OfferModel offerModel, required _i76.UserModel userModel})
      : super(name,
            path: '/offer-sent-detail-page',
...
class OfferSentDetailRouteArgs {
  ...
  final _i75.OfferModel offerModel;

  final _i76.UserModel userModel;
}

class PendingOrderDetailRoute
    extends _i1.PageRouteInfo<PendingOrderDetailRouteArgs> {
  PendingOrderDetailRoute({required String requestId})
      : super(name,
            path: '/pending-order-detail-page',
            args: PendingOrderDetailRouteArgs(requestId: requestId));

  static const String name = 'PendingOrderDetailRoute';
}

class PendingOrderDetailRouteArgs {
  const PendingOrderDetailRouteArgs({required this.requestId});
...
class OngoingOrderDetailRoute
  ...
  OngoingOrderDetailRoute({required String requestId})
      : super(name,
            path: '/ongoing-order-detail-page',
            args: OngoingOrderDetailRouteArgs(requestId: requestId));

  static const String name = 'OngoingOrderDetailRoute';
}

class OngoingOrderDetailRouteArgs {
  const OngoingOrderDetailRouteArgs({required this.requestId});
...
class CompletedOrderDetailRoute
  ...
  CompletedOrderDetailRoute({required String requestId})
      : super(name,
            path: '/completed-order-detail-page',
            args: CompletedOrderDetailRouteArgs(requestId: requestId));

  static const String name = 'CompletedOrderDetailRoute';
}

class CompletedOrderDetailRouteArgs {
  const CompletedOrderDetailRouteArgs({required this.requestId});
...
class NotificationDetailRoute
  ...
  NotificationDetailRoute({required _i77.NotificationModel notificationModel})
      : super(name,
            path: '/notification-detail-page',
...
class NotificationDetailRouteArgs {
  ...
  final _i77.NotificationModel notificationModel;
}
...
class ModificationBuyerRoute
  ...
  ModificationBuyerRoute({required _i78.OrderModel orderModel})
      : super(name,
            path: '/modification-buyer-page',
...
class ModificationBuyerRouteArgs {
  ...
  final _i78.OrderModel orderModel;
}

class ModificationDetailRoute
    extends _i1.PageRouteInfo<ModificationDetailRouteArgs> {
  ModificationDetailRoute({required _i79.ModificationModel modificationModel})
      : super(name,
            path: '/modification-detail-page',
...
class ModificationDetailRouteArgs {
  ...
  final _i79.ModificationModel modificationModel;
}

...
class AuthRepository implements BaseAuthRepository {
  ...
  verifyAsBuyer(UserModel user,String userid) async{
    try {
      await _read.read(firebaseFirestoreProvider).userDocumentRef(userid).set(UserModel(isBuyer: user.isBuyer,isPhoneNumberVerified: user.isPhoneNumberVerified, phoneNumber:_read.read(userControllerProvider)!.userModel.phoneNumber ),SetOptions(
        merge: true
      ));
    } on FirebaseAuthException catch (e) {
    throw CustomException(message: e.message);

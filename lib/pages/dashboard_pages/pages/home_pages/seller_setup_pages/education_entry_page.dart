...
class EducationEntryPage extends ConsumerWidget {
  const EducationEntryPage();

  @override
  Widget build(BuildContext context, ScopedReader watch) {
    var size = MediaQuery.of(context).size;
    final educationEntryListChangeNotifier = watch(educationEntryChangeNotifierProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          elevation: 0,
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      context.router.navigate(WorkEntryRoute());
                    },
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: CustomButtonSignup(buttonBg: const Color(0xff0000FF), buttonTitle: "NEXT  >", buttonFontColor: Colors.white, onButtonPressed: (){
                    context.read(sellerSetupStateProvider).state = context.read(sellerSetupStateProvider).state!.copyWith(saveEducationEntryModel:educationEntryListChangeNotifier.educationEntryModelList);
                    context.router.navigate(WorkEntryRoute());
                  }, imageIcon: null,),
                ),
              ),

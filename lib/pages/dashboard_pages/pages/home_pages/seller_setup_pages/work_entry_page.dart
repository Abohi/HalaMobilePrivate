...
class WorkEntryPage extends ConsumerWidget {
  const WorkEntryPage();

  @override
  Widget build(BuildContext context, ScopedReader watch) {
    var size = MediaQuery.of(context).size;
    final workEntryListChangeNotifier = watch(workEntryChangeNotifierProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          elevation: 0,
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      context.router.navigate(AchievementEntryRoute());
                    },
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: CustomButtonSignup(buttonBg: const Color(0xff0000FF), buttonTitle: "NEXT  >", buttonFontColor: Colors.white, onButtonPressed: (){
                    context.read(sellerSetupStateProvider).state = context.read(sellerSetupStateProvider).state!.copyWith(saveWorkEntryModel:workEntryListChangeNotifier.workEntryModelList);
                    context.router.navigate(AchievementEntryRoute());
                  }, imageIcon: null,),
                ),
              ),

...
class AchievementEntryPage extends ConsumerWidget {
  const AchievementEntryPage();

  @override
  Widget build(BuildContext context, ScopedReader watch) {
    var size = MediaQuery.of(context).size;
    final achievementEntryListChangeNotifier = watch(achievementEntryChangeNotifierProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          elevation: 0,
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: GestureDetector(
                    onTap: (){
                    context.router.navigate(ProfileDescriptionEntryRoute());
                    },
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 17),
                  child: CustomButtonSignup(buttonBg: const Color(0xff0000FF), buttonTitle: "NEXT  >", buttonFontColor: Colors.white, onButtonPressed: (){
                    context.read(sellerSetupStateProvider).state = context.read(sellerSetupStateProvider).state!.copyWith(saveAchievementList: achievementEntryListChangeNotifier.achievementEntryModelList);

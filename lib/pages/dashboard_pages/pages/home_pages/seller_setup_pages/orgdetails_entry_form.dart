...
class OrgDetailsEntryFormPage extends HookWidget {
  const OrgDetailsEntryFormPage();
                ...
                children: [
                  ...
                  CustomButtonSignup(buttonBg: const Color(0xff0000FF), buttonTitle: "NEXT  >", buttonFontColor: Colors.white, onButtonPressed: () async{
                      if(_formKey.currentState!.validate()){
                        ...
                        context.read(sellerSetupStateProvider).state = context.read(sellerSetupStateProvider).state!.copyWith(orgDetailModel: OrgDetailModel(
